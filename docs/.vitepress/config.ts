...
export default defineConfig({
  ...
  description:
    'FCC-Agile 生态官方文档：agile 工作区 CLI（.agile/settings.json 单一配置、外部资源 sync 同步、worktree 开发环境、项目模板脚手架）、Claude Code SDD/TDD 插件（15 个斜杠命令与 7 个角色 subagent）、项目模板注册中心的完整中文使用指南与开发指南。',
  base: '/agile-docs/',

  head: [
    ['link', { rel: 'icon', type: 'image/svg+xml', href: '/agile-docs/logo.svg' }],
    ['meta', { name: 'keywords', content: 'FCC-Agile, agile CLI, 工作区管理, settings.json, 外部资源同步, agile sync, git worktree, 项目模板, Claude Code 插件, SDD, TDD, 研发流程' }],
